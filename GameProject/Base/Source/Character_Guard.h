#ifndef CHARACTER_GUARD_H
#define CHARACTER_GUARD_H
...
class Character_Guard : public Character
{
private:
	enum SPRITE
	{
...
public:
	Character_Guard(Vector3 position, Mesh *sprite = NULL, PlayerCharacter *player = NULL);
	Character_Guard(Vector3 position, Mesh *sprite = NULL, float velocityx = 0, PlayerCharacter *player = NULL);
	~Character_Guard();
